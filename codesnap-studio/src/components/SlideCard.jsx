...
export default function SlideCard({ 
  ...
  React.useEffect(() => {
    ...
    highlight();
  }, [codeChunk, language, activeTheme.shiki]);
  ...
  return (
    ...
    >
      {/* Code Editor Mockup inside the slide */}
      <div className={`flex flex-col w-full flex-1 overflow-hidden transition-all duration-300 ${activeTheme.wrapper}`}>
        {renderFrame()}
        <div 
          className="flex-1 p-6 overflow-hidden pointer-events-none [&>pre]:!bg-transparent font-mono"
      ...
      <div className={`absolute bottom-6 left-8 right-8 flex justify-between items-center text-sm font-medium ${activeTheme.footerText} mix-blend-luminosity z-20`}>
        <span>{watermark}</span>
